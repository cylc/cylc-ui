...
describe('mergeQueries', () => {
  ...
  describe('Validation', () => {
    it('should throw an error if no query provided', () => {
      ...
      expect(() => {
        mergeQueries(undefined, undefined)
      }).to.throw()
      expect(() => {
        mergeQueries(undefined, {})
      }).to.throw()
      expect(() => {
        mergeQueries({}, undefined)
      }).to.throw()
    ...
    it('should throw an error if more than a single definition', () => {
      ...
      `
      expect(() => {
        mergeQueries(documentA, documentB)
      }).to.throw()
      expect(() => {
        mergeQueries(documentB, documentA)
      }).to.throw()
    })
